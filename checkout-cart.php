...
<body>
  ...
  foreach ($_SESSION['cart'] as $key => $value) {
    ...
    foreach ($result as $a) {
     ...
     <li class="d-flex align-items-center justify-content-between"><strong class="small fw-bold"><?php echo $a['title']; ?><div class="text-gray">x <?php echo $value['quantity']?></div></strong><span class="text-muted small"><?php echo $a['price']; ?></span></li>
