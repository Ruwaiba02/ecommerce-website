          ...
          <div class="container p-0">
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal small text-uppercase py-3 px-4 bg-light mb-3 fw-bold">
                  
              
                  <li><?php  echo '<a class="reset-anchor" href="shop2.php?category=' . $row['category_id'] . '">' . $row['category_name'] . '</a>'; ?></li>
              ...
              <div class="row mb-3 align-items-center">
                  ...
                  <input class="form-control " name="search_product" type="text" placeholder="Search">
                  </div>
                  <div class="col-lg-6" >
